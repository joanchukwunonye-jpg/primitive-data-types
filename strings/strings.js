...
let stringContainsIgnoreCase =
  mainStringIgnoreCase.toLowerCase().includes(subStringIgnoreCase.toLowerCase())
...
let lastCharacter =
  getLastCharacter.charAt(getLastCharacter.length - 1)
...
let lastSixCharacters =
  getLastSixCharacters.substring(getLastSixCharacters.length - 6)
...
testString2 = testString2
  .replace("I am the first sentence.", "I am the second best,")
  .replace("You are the second sentence", "you are the first best!")
  .toLowerCase()
